    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <h1 class="m-0">Tambah <span class="text-gradient">Kategori</span></h1>
                <p class="subtitle">Lengkapi informasi kategori yang akan ditambahkan ke sistem perpustakaan</p>
            </div>
        </div>
                        ...
                        <div class="form-header-row">
                            <div>
                                ...
                                <p class="form-subtitle">
                                    Lengkapi informasi kategori yang akan ditambahkan ke sistem perpustakaan
                                </p>
                            </div>
                            <div>
